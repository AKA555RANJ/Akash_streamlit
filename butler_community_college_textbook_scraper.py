...
BASE_URL = "https://bookstore.butlercc.edu"
COLLEGE_URL = BASE_URL + "/college"
AJAX_URL = BASE_URL + "/timber/college/ajax"

SCHOOL_ID = "3031358"
SCHOOL_NAME = "butler_community_college"
...
def main():
    parser = argparse.ArgumentParser(
        description="Scrape textbook data from Butler Community College bookstore (Timber)."
    )
