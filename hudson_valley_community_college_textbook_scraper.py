...
BASE_URL = "https://bookstore.hvcc.edu"
COLLEGE_URL = BASE_URL + "/college"
AJAX_URL = BASE_URL + "/timber/college/ajax"

SCHOOL_ID = "3067467"
SCHOOL_NAME = "hudson_valley_community_college"
...
def main():
    parser = argparse.ArgumentParser(
        description="Scrape textbook data from Hudson Valley Community College bookstore (Timber)."
    )
