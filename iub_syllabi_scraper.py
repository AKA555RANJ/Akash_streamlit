...
OUTPUT_DIR = os.path.join(
    ...
    "data",
    "indiana_university_bloomington__3029188__syllabus",
)
CSV_FILENAME = "indiana_university_bloomington__3029188__syllabus.csv"
...
def search_sections(session: requests.Session) -> list[dict]:
    ...
    payload = {
        ...
        "criteria": [
            {"field": "alias", "value": "*"},
            {"field": "campus", "value": "Bloomington Campus"},
        ],
    }
    resp = session.post(
        API_URL + "search",
    ...
    for section in tqdm(sections, desc="Processing sections", unit="section"):
        ...
        if existing:
            ...
            rows.append({
                ...
                "syllabus_filepath_local": f"../data/indiana_university_bloomington__{SCHOOL_ID}__syllabus/{ex_filename}",
        ...
        rows.append({
            ...
            "syllabus_filepath_local": f"../data/indiana_university_bloomington__{SCHOOL_ID}__syllabus/{filename}",
            "syllabus_filesize": str(filesize),
