#!/usr/bin/env python3
"""
midwestern_dg_textbook_scraper.py — Scrape textbook/course material information
from Midwestern University-Downers Grove's eCampus bookstore at midwestern.ecampus.com.

Uses FlareSolverr for Akamai bypass, then plain HTTP requests for API calls.

Usage:
    python midwestern_dg_textbook_scraper.py           # scrape only missing departments
    python midwestern_dg_textbook_scraper.py --fresh   # delete CSV and scrape everything
"""
...
def scrape(fresh=False):
    ...
    # Filter to Downers Grove campus: departments ending in 'D' or no D/G suffix
