#!/usr/bin/env python3
"""Parse Galen College booklist PDFs into a standardized CSV for San Antonio campus."""

import csv
import re
import fitz  # pymupdf

DATA_DIR = "data/galen_college_of_nursing_san_antonio__3094181__bks"
SOURCE_URL = "https://galen.libguides.com/Booklist"
SCHOOL_ID = "3094181"
CRAWLED_ON = "2026-03-19 00:00:00"

# PDF files and their metadata (includes VN Texas for San Antonio)
PDFS = [
    ("PN_Booklist_Summer_2026.pdf", "PN", "Summer 2026"),
    ("VN_Texas_Booklist_Summer_2026.pdf", "VN", "Summer 2026"),
...
def main():
    ...
    # Write CSV
    csv_path = f"{DATA_DIR}/galen_college_of_nursing_san_antonio__3094181__bks.csv"
    fieldnames = [
