#!/usr/bin/env python3
"""
University of Phoenix-Arizona Bookstore Textbook Scraper
Platform: bkstr.com (Follett) — svc.bkstr.com REST API
URL: https://www.bkstr.com/uofphoenixstore/shop/textbooks-and-course-materials
...
def parse_results(raw, source_url, dept, course, section, term_name):
    ...
    # Deduplicate across all courseSectionDTO entries in the response
    seen_mats = set()
